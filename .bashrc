...
alias la='ls -A'
alias l='ls -CF'
alias bashrc="xed '/home/carlosepc/.bashrc'"
alias brc="xed '/home/carlosepc/.bashrc'"
alias cntlmr='sudo service cntlm restart'
alias cntlme='sudo xed "/etc/cntlm.conf"'
alias cnr='sudo service cntlm restart'
alias cner='sudo xed /etc/cntlm.conf && service cntlm restart'
alias cne='sudo xed /etc/cntlm.conf'
alias wh='nmcli radio wifi on && nmcli connection up Hotspot'
alias webstorm20='/media/carlosepc/MisArchivos/Programs/Linux/WebStorm-203.7717.59/bin/webstorm.sh'
alias ws20='/media/carlosepc/MisArchivos/Programs/Linux/WebStorm-203.7717.59/bin/webstorm.sh'

#APPS
alias j8josm='/usr/lib/jvm/java-8-openjdk-amd64/jre/bin/java -Xmx2048M -jar /home/carlosepc/Applications/josm-tested.jar'

#DEV ALIASES


alias lxch='java -jar "/opt/lxc/lanxchange.jar"'
alias lanxchange='java -jar "/opt/lxc/lanxchange.jar"'
...
#USER 
#customize
PS1="\[\e]0;\u@\h: \w\a\]${debian_chroot:+($debian_chroot)}\[\033[44;01;34m\]\u@\h\[\033[40m\]:\[\033[01;34m\]\w\[\033[00m\]\$\n"
################################################################################
##  FUNCTIONS                                                                 ##
################################################################################
